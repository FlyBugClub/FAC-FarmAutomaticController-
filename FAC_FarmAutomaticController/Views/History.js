...
import { StyleSheet, Text, View, TouchableOpacity, SafeAreaView, Dimensions, ScrollView, statusbar, Image} from 'react-native';
...
const data = {
  ...
  const dataPremium = {
    ...
    legend: ["Humidity", "pH", "Pump"] // optional
  };
                            ...
                            {Premium ? (
                                <>
                                    <View style={{flexDirection: 'row', alignItems: 'center',}}>
                                        {/* <Icon name="water-drop" size={40} color={'#00b4d8'}/> */}
                                        <Image 
                                        source={require('../assets/img/humid.png')}
                                        resizeMode="contain"
                                        style={{
                                            width: 40,
                                            height: 40,
                                    ...
                                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                        {/* <AnDesign name="pump" size={40} color={'#00b4d8'}/> */}
                                        <Image 
                                        ...
                                        <Text style={{fontSize: 25, marginLeft: 2}}>{index+75}%</Text>
                                    </View>
                                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                        {/* <AnDesign name="pump" size={40} color={'#00b4d8'}/> */}
                                        <Image 
                                        ...
                                        <Text style={{fontSize: 25, marginLeft: 8}}>{index+68}ml</Text>
                                    </View>
                                </>
                            ) : (
                                <>
                                    ...
                                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                        ...
                                        <Text style={{fontSize: 25, marginLeft: 8}}>{index}</Text>
                                    </View>
                                </>
                            )
                            }
                ...
                <View style={styles.DataArea}>
                    {Premium ? (
                        <>
                            ...
                            <View>
                                <Text style={{textAlign: 'center', fontSize: 14}}>75%</Text>
                                <Text style={{fontSize: 14, color: '#80b918', fontWeight: 'bold'}}>pH</Text>
                            </View>
                            <View>
