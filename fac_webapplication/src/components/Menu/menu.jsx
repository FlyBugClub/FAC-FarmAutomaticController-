    ...
    <div className="Fac_Menu">
      <BrowserView className="Fac_Menu_Web">
        <div className="Fac_Menu_Web_Container">
          <img
            className="Fac_Menu_Web_Container_Logo"
            src="/icons/Bug(Trắng).png"
            alt=""
          />
          <div className="Fac_Menu_Web_Container_Menu">
            <div
              className="Fac_Menu_Web_Container_Menu_Elements"
            ...
            >
              <WiDayCloudy
                className="Fac_Menu_Web_Container_Menu_Elements_Icon"
                size={35}
              />
            </div>
            <div
          ...
          <div style={{ position: "relative", zIndex: "10" }}>
            <img
              className="Fac_Menu_Web_Container_Avartar"
              src="/icons/user.png"
              alt=""
            ...
            {userState === "user" ? (
              <div className="Fac_Menu_Web_Container_Dropbox">
                ...
                <div
                  className="Fac_Menu_Web_Container_Dropbox_Options"
                  onClick={() => {
